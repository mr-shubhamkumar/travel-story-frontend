...
function ViewTravelStory({ storyInfo, onClose, onEditClick, onEditDelete }) {
  return (
    <div className="relative">
        ...
        <div>
          <div className="flex items-center gap-3 bg-cyan-50/50 p-2 rounded-l-lg">
            <button className="btn-small " onClick={onEditClick}>
              <MdUpdate title="Update Story" className="text-lg" />
              Update Story
            </button>

            <button className="btn-small btn-delete" onClick={onEditDelete}>
              <MdDeleteOutline title="Delete Story" className="text-lg" />
              Delete Story
            </button>
      ...
      <div>
        <div className="flex-1 flex flex-col gap-2 py-4">
          <h1 className="text-2xl to-slate-950">
